...
* [autodefault](https://github.com/Lucretiel/autodefault): annpotate function to have them automatically insert `..Default::default()` into struct expressions. Useful when instantiating large, deeply nested components or component bundles.
