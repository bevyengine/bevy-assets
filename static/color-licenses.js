// colors from https://github.com/badges/shields/blob/master/services/licenses.js
...
document.querySelectorAll('.card-license').forEach(licenseTag => {
    var license = licenseTag.textContent.trim();
    license = license.split('/')[0];
    licenseTag.style.color = licenseToColor(license);
});
